...
public final class TabListRenderAdapter implements TargetRenderer {
    ...
    public TabListRenderAdapter(final ConfigService configService, final ActiveCosmeticResolver activeCosmeticResolver) {
    ...
    public void refresh(final Player player) {
        ...
        final Component prefix = activeTag.map(tag -> tag.prefix().rendered().append(Component.space()))
